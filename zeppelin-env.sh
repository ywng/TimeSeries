...
export ZEPPELIN_PORT=$(shuf -i 6000-9999 -n 1)
export ZEPPELIN_SSL_PORT=$(shuf -i 6000-9999 -n 1)
export ZEPPELIN_LOG_DIR=$HOME/zeppelin/logs
export ZEPPELIN_PID_DIR=$HOME/zeppelin/run
export ZEPPELIN_NOTEBOOK_DIR=$HOME/zeppelin/notebook
export ZEPPELIN_WAR_TEMPDIR=$HOME/zeppelin/webapps
#export ZEPPELIN_INTERPRETER_DIR=$HOME/zeppelin/conf
#export ZEPPELIN_INTERPRETER_CONF=$HOME/zeppelin/conf
export SPARK_HOME=/share/apps/spark/spark-1.6.0-bin-hadoop2.6
